const CACHE_NAME = 'rare-cocoa-assets-v33';
const ASSETS_TO_CACHE = [
  ...
  'assets/cranberryalmond_tablet2.avif?v=2',
  'assets/cranberry-blueberry_tablet.avif?v=2',
  'assets/cranberryblueberry_tablet2.avif?v=2',
  ...
  'assets/blueberryalmond2_tablet.avif?v=2',
